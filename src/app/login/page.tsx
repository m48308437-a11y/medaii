...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12 relative">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(22,217,197,0.05)_0%,transparent_60%)]" />
      <motion.div
      ...
      >
        <div className="glass rounded-3xl p-8 glow-primary">
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary text-sm">برای ادامه وارد حساب خود شوید</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-sm text-text-secondary">رمز عبور</label>
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <p className="text-xs text-muted text-center mb-4">یا ورود با</p>
            <div className="grid grid-cols-2 gap-3">
              <button type="button" className="py-2.5 px-4 rounded-xl border border-border text-text-secondary text-sm hover:border-primary/40 hover:text-white transition flex items-center justify-center gap-2">
